...
def _coords_to_geoid(lat: str, lon: str, zip_code: str) -> str:
    ...
    Retries up to 3 times with exponential backoff for transient timeouts.
    """
    ...
    raise ValueError(f"Census geocoding service unavailable after 3 attempts: {last_exc}") from last_exc
